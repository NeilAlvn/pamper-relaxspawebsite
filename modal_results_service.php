...
function getServiceDateRangeStats($conn, $start_date = null, $end_date = null) {
    $query = "
        SELECT
            COUNT(*) AS total,
...
$stats = getServiceDateRangeStats($conn, $start_date, $end_date);
